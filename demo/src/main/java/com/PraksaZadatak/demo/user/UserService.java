...
public class UserService {
    ...
    private void sendValidationEmail(User user) {
        ...
        String htmlContent = "<html><body style='background-color: #f5f5f5; padding: 20px;'>" +
                "<div style='text-align: center; height: 500px; width: 100%; max-width: 1000px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px; background-image: url(" + imageUrl + "); background-size: cover; background-position: center; font-family: \"Khand\", sans-serif;'>" +
                "<h1 style='color: white; margin-top:50px;'>Hello " + user.getUsername() + "!</h1>" +
                "<p style='color: white; margin-top: 290px;'>Click the button below to verify your account:</p>" +
